...
const int ReadHandler::BASE = 0x100000;
const ACE_Time_Value connTimeout = ACE_Time_Value(30,0);

ReadHandler::ReadHandler(const unsigned short port_) : port(port_), ACE_Event_Handler(), mStream(), mDataSize(0),
